...
export default function BranchListPage() {
  ...
  useEffect(() => {
    // loadBranches()'s setState calls all happen after an await, not synchronously within this
    // effect's execution -- the standard mount-time data-fetch pattern this rule can't
